...
describe("Single-emmited events", () => {
  test("single emmited event is not in main queue", () => {
  ...
  test("single emmited emits after time window", () => {
  ...
  test("single emmited event duration is respected", () => {
